...
class NavBar
{
    ...
    static function navBar($title = "Tuhogarconsentido")
    {
...
<input type="hidden" name="user_idSession" id="user_idSession" value=""> <!-- idUsuario -->
<input type="hidden" name="rol_idSession" id="rol_idSession" value=""> <!-- rolUsuario -->
